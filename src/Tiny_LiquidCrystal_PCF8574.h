/// \file Tiny_LiquidCrystal_PCF8574.h
...
///
/// \details
/// This library is can drive a Liquid Cristal display based on the Hitachi HD44780 chip that is connected through a PCF8574 I2C adapter using TinyWireM.
/// This is given by many (not all) LCD adapters. This library uses the TinyWireM library for communication.
...
#ifndef Tiny_LiquidCrystal_PCF8574_h
#define Tiny_LiquidCrystal_PCF8574_h
...
class Tiny_LiquidCrystal_PCF8574 : public Print
{
public:
  Tiny_LiquidCrystal_PCF8574(int i2cAddr);
